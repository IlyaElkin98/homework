...
##                                             ***ЗАДАНИЕ СЕДЬМОЕ - Библиотеки csv и pandas***
1. Создан новый модуль **transactions.py** в проекте. Этот модуль будет использоваться для считывания финансовых
    операциях с файлов табличного формата **csv** и **xlsx** в папке **scr**
2. Создан для тестирования **Mock и patch** файл **test_transactions_src_xlsx.py** в папке **tests**.

##                                              ***ЗАДАНИЕ ВОСЕМОЕ - Библиотеки re, collections, random***
1. Создан основной модуль программы **main.py** в проекте, которая отвечает за основную логику проекта и связывает функциональности между собой.
...
Счет**5907
Сумма: 41096.24 USD
2019-12-07T06:17:14.634890 Перевод организации
VisaClassic 2842 87** **** 9012 -> Счет **3655
Сумма: 48150.39 USD
2019-11-19T09:22:25.899614 Перевод организации
Maestro 7810 84** **** 5568 -> Счет **2869
Сумма: 30153.72 руб.
2019-11-13T17:38:04.800051 Перевод со счета на счет
Счет **9794 -> Счет **8125
Сумма: 62814.53 руб.
2019-11-05T12:04:13.781725 Открытие вклада
Счет**8381
Сумма: 21344.35 руб.
...
