...
def test_get_mask_account(score_or_card, total_result):
    assert get_mask_account(score_or_card) == total_result


def test_get_date1(date_1):
    assert get_date("2024-03-11T02:26:18.671407") == "11.03.2024"


def test_get_date2(date_2):
    assert get_date("") == "Пустая строка!"


def test_get_date3(date_3):
    assert get_date("21-11-2023T02:26:18.671407") == "21.11.2023"


def test_get_date4(date_4):
